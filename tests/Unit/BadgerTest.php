...
it('should generate a badge with { label, status }', function (): void {
    expect(Badger::from(['label' => 'npm', 'message' => 'v1.0.0'])->render())->toMatchSnapshot();
});

it('should generate a badge with { label, status, color }', function (): void {
    expect(Badger::from(['label' => 'npm', 'message' => 'v1.0.0', 'color' => 'ADF'])->render())->toMatchSnapshot();
});

it('should generate a badge with { label, status, style }', function (): void {
    expect(Badger::from(['label' => 'npm', 'message' => 'v1.0.0', 'style' => 'flat'])->render())->toMatchSnapshot();
});

it('should generate a badge with { label, status, color, style }', function (): void {
    expect(Badger::from(['label' => 'npm', 'message' => 'v1.0.0', 'color' => 'ADF', 'style' => 'flat'])->render())->toMatchSnapshot();
});

it('should generate a badge with { label, status, icon }', function () use ($icon): void {
    expect(Badger::from(['label' => 'docker', 'message' => 'icon', 'icon' => $icon])->render())->toMatchSnapshot();
});

it('should generate a badge with { status, icon }', function () use ($icon): void {
    expect(Badger::from(['label' => '', 'message' => 'icon', 'icon' => $icon])->render())->toMatchSnapshot();
});

it('should generate a badge with { status, icon, iconWidth }', function () use ($icon): void {
    expect(Badger::from(['label' => '', 'message' => 'icon', 'icon' => $icon, 'iconWidth' => 19])->render())->toMatchSnapshot();
});

it('should generate a badge with { label, status, icon, style }', function () use ($icon): void {
    expect(Badger::from(['label' => 'docker', 'message' => 'icon', 'style' => 'flat', 'icon' => $icon])->render())->toMatchSnapshot();
});
...
it('should generate a bare badge with { status }', function (): void {
    expect(Badger::from(['message' => 'v1.0.0'])->render())->toMatchSnapshot();
});

it('should generate a bare badge with { status, color }', function (): void {
    expect(Badger::from(['message' => 'v1.0.0', 'color' => 'ADF'])->render())->toMatchSnapshot();
});

it('should generate a bare badge with { status, style }', function (): void {
    expect(Badger::from(['message' => 'v1.0.0', 'style' => 'flat'])->render())->toMatchSnapshot();
});
