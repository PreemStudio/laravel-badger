...
it('should generate a badge with { label, status }', function (): void {
    assertMatchesSnapshot(Badger::from(['label' => 'npm', 'status' => 'v1.0.0'])->render());
});

it('should generate a badge with { label, status, color }', function (): void {
    assertMatchesSnapshot(Badger::from(['label' => 'npm', 'status' => 'v1.0.0', 'color' => 'ADF'])->render());
});

it('should generate a badge with { label, status, style }', function (): void {
    assertMatchesSnapshot(Badger::from(['label' => 'npm', 'status' => 'v1.0.0', 'style' => 'flat'])->render());
});

it('should generate a badge with { label, status, color, style }', function (): void {
    assertMatchesSnapshot(Badger::from(['label' => 'npm', 'status' => 'v1.0.0', 'color' => 'ADF', 'style' => 'flat'])->render());
});

it('should generate a badge with { label, status, icon }', function () use ($icon): void {
    assertMatchesSnapshot(Badger::from(['label' => 'docker', 'status' => 'icon', 'icon' => $icon])->render());
});

it('should generate a badge with { status, icon }', function () use ($icon): void {
    assertMatchesSnapshot(Badger::from(['label' => '', 'status' => 'icon', 'icon' => $icon])->render());
});

it('should generate a badge with { status, icon, iconWidth }', function () use ($icon): void {
    assertMatchesSnapshot(Badger::from(['label' => '', 'status' => 'icon', 'icon' => $icon, 'iconWidth' => 19])->render());
});

it('should generate a badge with { label, status, icon, style }', function () use ($icon): void {
    assertMatchesSnapshot(Badger::from(['label' => 'docker', 'status' => 'icon', 'style' => 'flat', 'icon' => $icon])->render());
});
...
it('should generate a bare badge with { status }', function (): void {
    assertMatchesSnapshot(Badger::from(['status' => 'v1.0.0'])->render());
});

it('should generate a bare badge with { status, color }', function (): void {
    assertMatchesSnapshot(Badger::from(['status' => 'v1.0.0', 'color' => 'ADF'])->render());
});

it('should generate a bare badge with { status, style }', function (): void {
    assertMatchesSnapshot(Badger::from(['status' => 'v1.0.0', 'style' => 'flat'])->render());
});
